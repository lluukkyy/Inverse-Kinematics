...
inline std::vector<int> rotateOrderIndex(RotateOrder o){
    switch (o) {
        case RotateOrder::XYZ: return {0,1,2};
        case RotateOrder::YZX: return {1,2,0};
        case RotateOrder::ZXY: return {2,0,1};
        case RotateOrder::XZY: return {0,2,1};
        case RotateOrder::YXZ: return {1,0,2};
        case RotateOrder::ZYX: return {2,1,0};
